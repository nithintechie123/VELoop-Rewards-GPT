...
export const mockPrizes = [
  {
    ...
    model: "128GB Deep Purple Titanium",
    winnerCount: 1,
...
export const mockActiveGiveaways = [
  ...
  },
  {
    ...
    position: 4,
    accentTheme: "orange",
    title: "VIP Mystery Prize Box",
    name: "VIP Mystery Prize Box (₹50,000 Vault)",
    description: "Exclusive VIP Mystery Star Box loaded with luxury vouchers and tech accessories.",
    subtitle: "Exclusive VIP Mystery Star Box loaded with luxury vouchers.",
    type: "digital",
    prizeType: PRIZE_TYPES.GIFT_CARD,
    claimType: "digital_email",
